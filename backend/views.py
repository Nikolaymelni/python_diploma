...
class RegisterAccount(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return JsonResponse({'Status': False, 'Errors': 'Required arguments not provided'})
...
class LoginAccount(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if {'email', 'password'}.issubset(request.data):
            ...
            return JsonResponse({'Status': False, 'Errors': 'auth error'})
...
class BasketView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return JsonResponse({'Status': False, 'Errors': 'Required arguments are not provided'})
